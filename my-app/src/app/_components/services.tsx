...
const services = [
    {
        title:"Banho & Tosa",
        discription: "inclui banho com produtos especificos para o tipo de pelagem e pele do animal, corte de unhas, limpeza das orelhas e tosa personalizado (higienica ou estilizada).",
        duration: "1h",
        price:"$50",
        icon: <Scissors />,
        linkText: 'ola, vi no site sobre banho e tosa e gostaria de mais informações'
    },
        {
        title:"Banho & Tosa",
        discription: "inclui banho com produtos especificos para o tipo de pelagem e pele do animal, corte de unhas, limpeza das orelhas e tosa personalizado (higienica ou estilizada).",
                    ...
                    <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                      <div className="flex-1 flex items-start justify-between">
                        <div className="flex gap-3">
                          ...
                          <div>
                            <h3 className="text-3xl select-none">
                              {item.title}
                            </h3>
